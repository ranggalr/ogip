@extends('layouts.ogip-form', ['title' => 'International Reservoir Simulation Competition Registration'])

@section('body')
<div x-data="simres_app()">
        ...
        <div class="flex min-h-screen overflow-hidden">
            ...
            <div class="flex flex-col justify-center flex-1 px-4 py-12 overflow-hidden sm:px-6 lg:flex-none lg:px-20 xl:px-24 ">
                <div class="w-full max-w-xl mx-auto lg:w-96 overflow-y-auto h-screen">
                    <div>
                        <a href="{{ route('competition.reservoir-simulation') }}" class="text-ogip-3 text-medium">International Reservoir Simulation
                            Competition</a>
