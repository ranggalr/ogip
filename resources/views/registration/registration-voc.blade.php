    ...
    <section class="overflow-hidden">
      ...
      ">
            <div class="w-full max-w-xl mx-auto lg:w-96 overflow-y-auto h-screen">
              <div>
                <a href="{{ route('event.voc') }}" class="text-ogip-3 text-medium">Video Of OGIP Challenge</a>
                <h2 class="mt-6 text-3xl font-extrabold text-neutral-600">Registration</h2>
                <h6 class="text-base text-gray-500">Please check upload rules before uploading by clicking <a href="{{ route('event.voc') }}#details" class="text-gray-800">here</a></h6>
              </div>
              <div class="mt-8">
                <div class="mt-6">
                  <form action="#" method="POST" class="space-y-6" @submit.prevent="submitForm">
                    ...
                    <div class="space-y-1">
                      <label for="line" class="block text-sm font-medium text-neutral-600"> ID Line </label>
                      <div class="mt-1">
                        <input id="line" name="line" type="text" autocomplete="current-line" required="" x-model="state.line" placeholder="Your LINE ID" class="
                      block
                      w-full
                      px-5
                      py-3
