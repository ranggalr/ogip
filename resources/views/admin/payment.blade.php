              ...
              <table class="min-w-full">
                <thead class="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase "> Competititon </th>
                    <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase "> Payment Proof </th>
                  </tr>
                </thead>
                <tbody>
                  <!-- Odd row -->
                  @forelse ($payments as $i)
                    <tr class="bg-white">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap"> {{ $i->competition }} </td>
                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap"><a href="{{ route('admin.payment.download', ['payment' => $i->id]) }}" class="p-4 rounded-xl bg-ogip-2 text-gray-200">Download</a></td>
                    </tr>
                  @empty
