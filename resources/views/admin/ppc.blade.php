                ...
                <tbody>
                  ...
                  @forelse ($ppc as $i)
                    <tr class="bg-white">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap"><a href="{{ route('admin.ppc.view', ['ppc' => $i->id]) }}" class="p-4 rounded-xl bg-ogip-2 text-gray-200">View</a></td>
                    </tr>
                  @empty
