          ...
          <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded">
              <table class="min-w-full">
                ...
                <tbody>
                  <!-- Odd row -->
                  @forelse ($smartCompetitions as $i)
                    <tr class="bg-white">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap"><a href="{{ route('admin.smart-competition.view', ['smartCompetition' => $i->id]) }}" class="p-4 rounded-xl bg-ogip-2 text-gray-200">View</a></td>
                    </tr>
                  @empty
