...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
      <div class="flex flex-wrap items-center mx-auto max-w-7xl">
        <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
          ...
          "></div>
              <div class="relative">
                <img class="object-cover object-center mx-auto rounded-lg" alt="hero" src="{{ asset('img/logo lomba/Pre-event/VOC-01.png') }}">
              </div>
            </div>
          </div>
        </div>
    ...
    ">
      ...
      "> Video Of Ogip Challenge</h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-300"> MAXIMIZING THE SOCIAL MEDIA USAGE FOR  PETROLEUM INDUSTRY BRANDING </p>
  ...
  <section id="details">
    ...
    ">
        ...
        lg:text-5xl
      "> Details </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-500">VOC (Video of OGIP Challange), participants will be asked to make a promotional video for OGIP 2022 as creative and interesting as possible. The best 3 participants will get prizes and the video will be shown on all of the official social media of OGIP 2022.
              <br /><span class="font-bold">Upload Rules</span>
              <ol class="list-decimal text-gray-500 leading-relaxed text-base">
                  ...
                  <li>The video is prohibited from containing elements of SARA (Ethnicity, Religion, Race and Intergroup), pornography, or hate speech.</li>
                  <li>Upload tiktok, reels, and Instagram stories by tagging all ogip accounts post to Instagram stories by tagging ogip as well.</li>
                  <li>Use this hashtag:
                      <ul class="list-disc">
                          <li>#OGIP2022 </li>
                  ...
                  <li>Please rename your video in the following format : <br />OGIP2022_ SUBTOPIC_ NAME <br />Example : OGIP2022 _PETROLEUM INDUSTRY_NAOMI</li>
                  <li>Don’t forget to submit your video via this link : <a href="http://bit.ly/UPLOADVOC">http://bit.ly/UPLOADVOC</a> </li>
