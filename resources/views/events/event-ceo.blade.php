...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
      <div class="flex flex-wrap items-center mx-auto max-w-7xl">
        <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
          ...
          "></div>
              <div class="relative">
                <img class="object-cover object-center mx-auto rounded-lg" alt="hero" src="{{ asset('img/logo lomba/Pre-event/CEO Talk-01.png') }}">
              </div>
            </div>
          </div>
        </div>
      ...
      "> CEO Talk</h1>
          ...
          <div class="mt-0 lg:mt-6 max-w-7xl sm:flex">
            <div class="mt-3 rounded-lg sm:mt-0">
              <a href="{{ route('event.ceo-talk.registration') }}"  class="
            items-center
            block
            px-10
            py-4
  ...
  <section id="details">
    ...
    ">
        ...
        lg:text-5xl
      "> Details </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-500">Give insight to the participants about new era of world energy challenges and its impacts especially in Indonesia, regulation modification due to changes, and how to deal with it. With the speakers from oil and gas company executives or officials.</p>
        </div>
