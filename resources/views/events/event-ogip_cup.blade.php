...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
      <div class="flex flex-wrap items-center mx-auto max-w-7xl">
        <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
          ...
          "></div>
              <div class="relative">
                <img class="object-cover object-center mx-auto rounded-lg" alt="hero" src="{{ asset('img/logo lomba/Pre-event/OGIP Cup-01.png') }}">
              </div>
            </div>
          </div>
        </div>
    ...
    ">
        ...
        lg:text-5xl
      "> OGIP CUP</h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-300"> THE ONE AND ONLY : THE REMARKABLE CHAMPION’S AWARD </p>
  ...
  <section id="details">
    ...
    ">
        ...
        lg:text-5xl
      "> Details </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-500">The prestigious award for the most winning university in the OGIP intellectual competitions.</p>
        </div>
