...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
      <div class="flex flex-wrap items-center mx-auto max-w-7xl">
        <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
          ...
          "></div>
              <div class="relative">
                <img class="object-cover object-center mx-auto rounded-lg" alt="hero" src="{{ asset('img/logo lomba/Pre-event/Petroleum Insight-01.png') }}">
              </div>
            </div>
          </div>
        </div>
    ...
    ">
      ...
      "> Petroleum Insight</h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-300"> ESCALATE YOUR SKILLS TO MAKE A BREAKTHROUGH IN  THE  FUTURE OF  OIL AND GAS INDUSTRY </p>
          <div class="mt-0 lg:mt-6 max-w-7xl sm:flex">
            <div class="mt-3 rounded-lg sm:mt-0">
              <a href="{{ route('event.petroleum-insight.registration') }}" class="
            items-center
            block
            px-10
            py-4
  ...
  <section id="details">
    ...
    ">
        ...
        lg:text-5xl
      "> Details </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-500">PI (Petroleum Insight) consist of 2 type of event, there’s Petroleum Talk and Petroleum Workshop Field. This event will bring experts in Oil and Gas Industry to satisfy your curiosity about the topic.</p>
        </div>
