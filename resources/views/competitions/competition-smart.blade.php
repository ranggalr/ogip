...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
      <div class="flex flex-wrap items-center mx-auto max-w-7xl">
        <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
          ...
          "></div>
              <div class="relative">
                <img class="object-cover object-center mx-auto rounded-lg" alt="hero" src="{{ asset('img/logo lomba/Smart Competition-01.png') }}">
              </div>
            </div>
          </div>
        </div>
    ...
    ">
      ...
      "> International Smart Competition</h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-300"> BRING THE  BRIGHT  FUTURE WITH ADVANCE KNOWLEDGE THROUGH COMPETITIVE COMPETITION TO OVERCOME SUSTAINABLE ENERGY </p>
          <div class="mt-0 lg:mt-6 max-w-7xl sm:flex">
            <div class="mt-3 rounded-lg sm:mt-0">
              <a href="{{ route('competition.smart-competition.registration') }}" class="
            items-center
            block
            px-10
            py-4
