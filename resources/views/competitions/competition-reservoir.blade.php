...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
    <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
      <div class="flex flex-wrap items-center mx-auto max-w-7xl">
        <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
          ...
          "></div>
              <div class="relative">
                <img class="object-cover object-center mx-auto rounded-lg" alt="hero" src="{{ asset('img/logo lomba/Simulasi reservoir-01.png') }}">
              </div>
            </div>
          </div>
        </div>
    ...
    ">
      ...
      "> International Reservoir Simulation Competition </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-300"> OIL AND GAS SIMULATION ENERGY BREAKTHROUGH IN THE NEW ERA OF WORLD ENERGY CHALLENGES </p>
          <div class="mt-0 lg:mt-6 max-w-7xl sm:flex">
            <div class="mt-3 rounded-lg sm:mt-0">
              <a href="{{ route('competition.reservoir-simulation.registration') }}" class="
            items-center
            block
            px-10
            py-4
  ...
  <section id="details">
    ...
    ">
        ...
        lg:text-5xl
      "> Details </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-500">To enhance participant creativity and accuracy and also compete on simulation and to obtain informations about the potential petroleum reserves.</p>
        </div>
