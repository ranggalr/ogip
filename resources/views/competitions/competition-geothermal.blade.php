...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
  ...
  <section id="details">
    ...
    ">
        ...
        lg:text-5xl
      "> Details </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-500">One of the prestigious competitions in OGIP 2022 that challenge participants to resolve problem with their knowledge for solving the geothermal’s case.</p>
        </div>
