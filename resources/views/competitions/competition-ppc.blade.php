...
<section class="bg-cover h-screen" style="background-image: url('{{ asset('img/bg-hero.svg') }}')">
  ...
  <section id="details">
    ...
    ">
        ...
        lg:text-5xl
      "> Details </h1>
          <p class="mb-8 text-base leading-relaxed text-left text-gray-500">Paper and Poster Competiton is a platform to compose and mold both ideas and innovation in oil and gas world in order to solve the issues concerning in oil and gas industry.
