...
__webpack_require__(/*! ./ogip */ "./resources/js/ogip.js");
  ...
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (!Object.values(this.state).includes(null)) {
        axios.post(route('event.voc.registration'), this.state).then(function (resp) {
  ...
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (this.validateForm()) {
        axios.post(route('competition.smart-competition.registration'), this.state).then(function (resp) {
...
window.ppc_app = function () {
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (this.validateForm()) {
        axios.post(route('competition.paper-poster.registration'), this.state).then(function (resp) {
          if (resp.data.status == 'success') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
...
window.gcs_app = function () {
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (this.validateForm()) {
        axios.post(route('competition.geothermal.registration'), this.state).then(function (resp) {
          if (resp.data.status == 'success') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
...
window.simres_app = function () {
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (this.validateForm()) {
        axios.post(route('competition.reservoir-simulation.registration'), this.state).then(function (resp) {
          if (resp.data.status == 'success') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
...
window.pod_app = function () {
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (this.validateForm()) {
        axios.post(route('competition.plan-of-development.registration'), this.state).then(function (resp) {
          if (resp.data.status == 'success') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
...
window.ord_app = function () {
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (this.validateForm()) {
        axios.post(route('competition.oil-rig-design.registration'), this.state).then(function (resp) {
          if (resp.data.status == 'success') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
  ...
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (!Object.values(this.state).includes(null)) {
        ...
        axios.post(route('payment.store'), formData).then(function (resp) {
          if (resp.data.status != 'error') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
...
window.pi_app = function () {
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (!Object.values(this.state).includes(null)) {
        axios.post(route('event.petroleum-insight.registration'), this.state).then(function (resp) {
          if (resp.data.status != 'error') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
...
window.ceo_app = function () {
  return {
    ...
    submitForm: function submitForm() {
      ...
      if (!Object.values(this.state).includes(null)) {
        axios.post(route('event.ceo-talk.registration'), this.state).then(function (resp) {
          if (resp.data.status != 'error') {
            swal.fire({
              icon: 'success',
              title: 'HOORAY!',
